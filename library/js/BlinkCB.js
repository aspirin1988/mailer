    ...
    IpxModule: function () {
        ...
        xhr.onreadystatechange = function() {
            ...
            if(template !== false) {
                ...
                function showIconsInterval(element, position, iteration, deleteClass, addClass) {
                    setTimeout(function() {
                ...
                function hideIconsInterval(element, position, iteration, deleteClass, addClass) {
                    setTimeout(function() {
